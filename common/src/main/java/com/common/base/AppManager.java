...
public class AppManager {
    ...
    private static Stack<Activity> resumeActivityStack;
    ...
    public static Stack<Activity> getResumeActivityStack() {
        return resumeActivityStack;
    }
    ...
    public void addResumeActivity(Activity activity) {
        if (resumeActivityStack == null) {
            resumeActivityStack = new Stack<Activity>();
        }

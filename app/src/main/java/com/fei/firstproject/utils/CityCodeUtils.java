...
public class CityCodeUtils {
    ...
    public ArrayList<String> getProvince(List<CityEntity> provice) {
    ...
    public ArrayList<String> getCity(
            HashMap<String, List<CityEntity>> cityHashMap, String provicecode) {
    ...
    public ArrayList<String> getCouny(
        ...
        if (couny == null) {
            couny = new ArrayList<CityEntity>();
        } else {
            couny.clear();
        }

 ...
 * 
 */
public class ScrollerNumberPickerView extends View {
	/** 控件宽度 */
	...
	public ScrollerNumberPickerView(Context context, AttributeSet attrs,
									int defStyle) {
	...
	public ScrollerNumberPickerView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initData();
	}
	...
	private void init(Context context, AttributeSet attrs) {
		TypedArray attribute = context.obtainStyledAttributes(attrs,
				R.styleable.ScrollerNumberPickerView);
		unitHeight = (int) attribute.getDimension(
				R.styleable.ScrollerNumberPickerView_unitHight, 32);
		normalFont = attribute.getDimension(
				R.styleable.ScrollerNumberPickerView_normalTextSize, 14.0f);
		selectedFont = attribute.getDimension(
				R.styleable.ScrollerNumberPickerView_selecredTextSize, 22.0f);
		itemNumber = attribute.getInt(R.styleable.ScrollerNumberPickerView_itemNumber, 7);
		normalColor = attribute.getColor(
				R.styleable.ScrollerNumberPickerView_normalTextColor, 0xff000000);
		selectedColor = attribute.getColor(
				R.styleable.ScrollerNumberPickerView_selecredTextColor, 0xffff0000);
		lineColor = attribute.getColor(R.styleable.ScrollerNumberPickerView_lineColor,
				0xff000000);
		maskHight = attribute.getDimension(
				R.styleable.ScrollerNumberPickerView_maskHight, 48.0f);
		noEmpty = attribute.getBoolean(R.styleable.ScrollerNumberPickerView_noEmpty,
				false);
		isEnable = attribute.getBoolean(R.styleable.ScrollerNumberPickerView_isEnable,
				true);
		attribute.recycle();

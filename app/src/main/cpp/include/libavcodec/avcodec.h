 ...
 * avcodec_receive_packet() functions provide an encode/decodePacket API, which
 ...
 * not all output was received. You can use this to structure alternative decodePacket
...
/**
 * Only decodePacket/encode grayscale.
 */
...
/**
 * Generate/parse ICC profiles on encode/decodePacket, as appropriate for the type of
...
#define FF_MB_DECISION_RD     2        ///< rate distortion
     ...
     * - encoding: Not used.
     * - decoding: Set by user.
     * Decoder will decodePacket to this format if it can.
     */
...
#define FF_BUG_IEDGE           32768
     ...
     * unofficial and experimental (that is, they always try to decodePacket things
 ...
 *
 * For example, this can be used to try to decodePacket baseline profile H.264
